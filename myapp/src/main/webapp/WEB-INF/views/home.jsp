...
<body>
	...
	<form id="testForm" action="${pageContext.request.contextPath}/test.do" method="post">
		x : <input type="text" name="x" /> <br /> y : <input type="text"
			name="y" /> <br />
		<p>음식주문</p>
		<input type="checkbox" name="food" value="pizza" /> 피자 <input
			type="checkbox" name="food" value="sand" /> 샌드위치 <input
			type="checkbox" name="food" value="spa" /> 스파게티 <br />
		<p>자격증</p>
...
<!-- 구버전의 브라우저에서는 지원하지 않으며, 템플릿 내용은 template 엘리먼트의 content 속성을 통하여 사용 -->
	...
	<script type="text/javascript">
		//추가버튼을 클릭하면, 자격증 1개정보를 입력할수 있는 <tr>을 tbody에 추가
